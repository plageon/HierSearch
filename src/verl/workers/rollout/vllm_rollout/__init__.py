...
if package_version <= "0.6.3":
    ...
    from .vllm_rollout import vLLMRollout, vLLMRolloutWithSearch  # noqa: F401
else:
    vllm_mode = "spmd"
    from .vllm_rollout_spmd import vLLMAsyncRollout, vLLMRollout, vLLMRolloutWithSearch  # noqa: F401
